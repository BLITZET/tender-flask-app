...
# Initialize database helper - configuración para producción
db = DatabaseHelper(
...
if __name__ == "__main__":
    ...
    try:
        # En producción, TMDHosting usará gunicorn, así que esto solo corre en desarrollo
    ...
    setup_custom_print()
    start_background_processing()
    print("🚀 Aplicación de licitaciones iniciada en modo producción")
    print("📍 Ruta base: /tender")